let idleSpriteSheet = new Image("assets/personagem/idle_spritesheet.png", RAM);
let attackSpriteSheet = new Image("assets/personagem/attack_spritesheet.png", RAM);
let laserImage = new Image("assets/laser/laser.png", RAM);
